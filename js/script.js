...
jQuery(function ($) {
   ...
   ====================================== */
    ...
    if ($("#technologies").length) {
        var app = document.getElementById("technologies");
        var personal = new Typewriter(app, {
            loop: true
        }); //"Blockchain", "Artificial Intellegance", "Internet of Things", "Mobility"
        personal.typeString('Artificial Intelligence').pauseFor(2000).deleteAll()
        .typeString('Big Data Analytics').pauseFor(2000).deleteAll()
        .typeString('Internet Of Things').pauseFor(2000).deleteAll()
        .typeString('Blockchain').pauseFor(2000).deleteAll().start();
    }
    /* =====================================
